    ...
    <script type="text/javascript">
        ...
        $(function () {
            ...
            $("#loginForm").bind("submit", function () {
                $.post("${ctx}/admin/login", $(this).serialize(), function (result) {
                    if (result.success) {
                        location.href = "${ctx}/main/main.jsp";
                    } else {
                        $("#message").empty();
                        $("#message").append("错误原因:" + result.message);
                    }
                }, "JSON");
                return false;
            });
        ...
        <table>
            ...
            <tr>
                ...
                <td>
                    ...
                    <img id="captchaImage" class="captchaImage" src="${ctx}/validate/code" title="点击更换验证码"/>
                </td>
            </tr>
            <tr>
                <td>
            ...
            <tr>
                ...
                <th>&nbsp;</th>
                <td>
                    <span id="message" style="color:red;font-size: 3px;"></span></br>
