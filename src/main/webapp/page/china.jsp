...
<script type="text/javascript">
    ...
    $(function () {
        $.post("${pageContext.request.contextPath}/user/distribution", {gender: '男'}, function (data) {
            //console.log(data);
            myChart.setOption({
                series: [{
                    // 根据名字对应到相应的系列
        ...
        $.post("${pageContext.request.contextPath}/user/distribution", {gender: '女'}, function (data) {
            //console.log(data);
            myChart.setOption({
                series: [{
                    // 根据名字对应到相应的系列
